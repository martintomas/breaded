...
class SubscriptionPeriodsHelperTest < ActionView::TestCase
  test '.boxes_names_for' do
    ...
    assert_equal I18n.t("app.users.show.boxes_names.box_1"), boxes_names_for(order_1)
    assert_equal I18n.t("app.users.show.boxes_names.box_2"), boxes_names_for(order_2)
  end
  ...
  test '.order_due_date_for' do
    ...
    inner_text = I18n.t('app.users.show.order_till', box: boxes_names_for(order_2), date: order_2.editable_till.strftime('%A, %d %b')) + ' ' +
