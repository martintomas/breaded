...
namespace :db do
  ...
  task :demo_seed, [] => :environment do
    ...
    puts 'Foods'
    Seeds::FillFoods.perform_for [{ name: 'Flaky Honey Brioche', description: 'Put description here', image: 'product-1.png', producer: 'The Slice',
                                  ...
                                  { name: 'Multigrain Seeded Bread', description: 'Put description here', image: 'product-2.png', producer: 'The Slice',
                                  ...
                                  { name: 'Galician Bread', description: 'Put description here', image: 'product-3.png', producer: 'The Slice',
                                  ...
                                  { name: 'Overnight Rye Bread', description: 'Put description here', image: 'product-4.png', producer: 'Bread & Butter',
                                    tags: [{ name: 'Rye', tag_type: TagType.the_category },
                                           { name: 'Rye & Bread Flour', tag_type: TagType.the_ingredient },
                                           { name: 'Eggs', tag_type: TagType.the_ingredient },
                                           { name: 'Honey', tag_type: TagType.the_ingredient }]},
                                  { name: 'Oatmeal Maple Bread', description: 'Put description here', image: 'product-5.png', producer: 'Bread & Butter',
                                    tags: [{ name: 'Brioche', tag_type: TagType.the_category },
